...
public class GameEngine extends Observable {
	 ...
	 */
	private Cell[][] cells;
	private static String recordRevive = "revive";// inserrido p observer
	private static String recordKill = "kill";// inserrido p observer
	...
	public void nextGeneration() {
		...
		for (Cell cell : mustRevive) {
			...
			notifyObservers(recordRevive);
		}

		for (Cell cell : mustKill) {
			cell.kill();
			setChanged(); // indica que o estado do objeto mudou.
			notifyObservers(recordKill);
		}
